...
@Component({
  selector: 'app-thessalonians2',
  templateUrl: './thessalonians2.page.html',
  styleUrls: ['./thessalonians2.page.scss'],
})
export class Thessalonians2Page implements OnInit {
