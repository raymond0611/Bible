...
@Component({
  selector: 'app-corinthians2',
  templateUrl: './corinthians2.page.html',
  styleUrls: ['./corinthians2.page.scss'],
})
export class Corinthians2Page implements OnInit {

  percentage = 0;
  buttonCount = 13; // 假設你有50個按鈕
  increment = 100 / this.buttonCount; //100除以每一個按鈕的數量
  buttonStates = Array(this.buttonCount).fill(false); // 初始化按鈕狀態為false
  pageIndex = 12; // 假設這是第一個子頁面
