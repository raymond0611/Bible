...
@Component({
  selector: 'app-timothy2',
  templateUrl: './timothy2.page.html',
  styleUrls: ['./timothy2.page.scss'],
})
export class Timothy2Page implements OnInit {

  percentage = 0;
  buttonCount = 4; // 假設你有50個按鈕
  increment = 100 / this.buttonCount; //100除以每一個按鈕的數量
  buttonStates = Array(this.buttonCount).fill(false); // 初始化按鈕狀態為false
  pageIndex = 21; // 假設這是第一個子頁面
